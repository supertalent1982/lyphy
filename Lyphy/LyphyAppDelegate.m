...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    LyphyLandingViewController *landingViewController = [[LyphyLandingViewController alloc] initWithNibName:@"LyphyLandingViewController" bundle:nil];
    self.viewController = [[UINavigationController alloc]  initWithRootViewController:landingViewController];
    ...
    self.buddyArray = [NSMutableArray array];
...
- (void)xmppRoster:(XMPPRoster *)sender didReceivePresenceSubscriptionRequest:(XMPPPresence *)presence
{
    ...
    if (![displayName isEqualToString:jidStrBare])
    {
        ...
        if (displayName != nil)
            ...
            body = [NSString stringWithFormat:@"Buddy request from %@", jidStrBare];
    }
    else
    {
        // body = [NSString stringWithFormat:@"Buddy request from %@", displayName];
...
- (void)alertView:(UIAlertView *)alertView clickedButtonAtIndex:(NSInteger)buttonIndex
{
    ...
    {
        //Accept
        [xmppRoster acceptPresenceSubscriptionRequestFrom:self.pendingJid andAddToRoster:YES];
        
    }
    else
    {
        //reject
        [xmppRoster rejectPresenceSubscriptionRequestFrom:self.pendingJid];
    }
}
